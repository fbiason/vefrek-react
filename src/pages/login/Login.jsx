        ...
        <div className="row gx-lg-5 align-items-center mb-5">
          <div className="col-lg-6 mb-5 mb-lg-0">
            <h1 className="my-5 display-5 fw-bold ls-tight" style={{ color: "hsl(218, 81%, 95%)" }}>
              ...
              <img className="vefrek-logo img-fluid" src="/images/logos/logo-vefrek.png" alt="Vefrek" /> para incrementar sus ventas
              <br />
              <span style={{ color: "hsl(218, 81%, 75%)" }}>¡TOTALMENTE GRATIS!</span>
            </h1>
          </div>
          ...
          <div className="col-lg-6">
            <div className="card shadow-2-strong" style={{ borderRadius: "1rem" }}>
              <div className="card-body p-4 text-center">
                ...
                <div className="form-outline mb-4">
                  <input type="email" name="email" className="form-control" placeholder="Contraseña" />
                </div>

                <div className="txt-form mb-4">
                  <label className="form-check-label text-center">
                    <Link className="link-dropdown" to="/Terminos" onClick={toTyC}>
                      <p className=" text-start"> Terminos y Condiciones </p>
                    </Link>
                    ...
                    <div className="col">
                      <button className="facebook-button btn-outline-primary w-100 my-1">
                        <div className="row align-items-center">
                          ...
                          <Link className="col-10 text-center link-red" to={`${process.env.REACT_APP_API_URL}api/auth/facebook`}>
                    ...
                    <div className="col">
                      <button className="google-button mt-2">
                        <div className="row align-items-center">
                          ...
                          <Link className="col-10 text-center link-red" to={`${process.env.REACT_APP_API_URL}api/auth/google`}>
