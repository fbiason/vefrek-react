                ...
                >
                  <div className="card-body p-4 text-center">
                    ...
                    <div className="container w-100 my-3">
                      <div className="col">
                        <button className="facebook-button btn btn-outline-primary w-100 my-1">
                          <div className="row align-items-center">
                            ...
                            <Link className="col-10 text-center" to={`${process.env.REACT_APP_API_URL}api/auth/facebook`}>
                        ...
                        <div className="col">
                          <button className="google-button mt-2">
                            <div className="row align-items-center">
                              ...
                              <Link className="col-10 text-center" to={`${process.env.REACT_APP_API_URL}api/auth/google`}>
