...
const PaginaEmpresa = () => {
    ...
    useEffect(() => {
        if (!reviewsJSX.length) return;

        setComments(reviewsJSX.slice(0, 3));
    }, [reviewsJSX])
                                    ...
                                    <div className="img-negocio">
                                        <Slider {...settings}>
                                            {imagenes.map((imagen, index) => (
                                                <div key={index}>
                                                    <img
                                                        className={`img-fluid cursor-pointer ${imagenSeleccionada === index
                                                            ? "imagen-seleccionada"
                                                            : ""
                                                            }`}
                                                        src={imagen}
                                    ...
                                    <div className="col-md-12 col-sm-6 d-block d-sm-none">
                                        ...
                                        <Slider className="carrusel-mobi">
                                            {imagenes.map((imagen, index) => (
                                                <div key={index}>
                                                    <img
                                                        className={`h-72 w-128 cursor-pointer ${imagenSeleccionada === index
                                                            ? "imagen-seleccionada"
                                                            : ""
                                                            } img-fluid`}
                                                        src={imagen}
                                            ...
                                            <>
                                                {
                                                    comments.length === 3 ?
                                                        <p 
                                                            onClick={() => setComments(reviewsJSX)}
                                                            className="pagina_empresa_ver_mas"
                                                        >
                                                            ver más comentarios...
                                                        </p>
                                                    :
                                                        <p 
                                                            onClick={() => setComments(reviewsJSX.slice(0, 3))}
                                                            className="pagina_empresa_ver_mas"
                                                        >
                                                            ver menos...
                                                        </p>
