...
import "../styles/pages/paginaEmpresa.css";
            ...
            <div>
              <div className="commentsData">
                ...
                {userData.isLogged && userData.email === review.email && (
                  <button
                    className="btn-icon"
                    onClick={() => handleEditOpinion(review._id)}
                  >
                    <Edit />
                  </button>
                )}
    ...
    <section className="background">
      <div className="contenedor-principal">
        ...
        <div className="columna columna-principal">
          ...
          <div className="fila-logo-nombre">
            {/* Logo de la empresa */}
          ...
          <div className="fila-pagina-negocios">
            <div className="info-contenedor">
              <div className="info-separador"></div>
              ...
              {userData.isLogged && (
                <div className="escribir-resena">
                  ...
                  <textarea
                    ...
                    maxLength={500}
                  />
                  <button className="btn-enviar-resena" onClick={sendFeedback}>
                    Enviar opinión
                  </button>
                </div>
              )}
        ...
        <div className="columna columna-principal">
          ...
          <div className="datos-direccion">
            <h3 className="datos-subtitulo">Dirección</h3>
            <p className="datos-valor">
              {companyData.location}, {companyData.city}, {companyData.state}
            </p>
          </div>
          ...
          {companyData.website && (
            <div className="datos-sitio-web">
              <h3 className="datos-subtitulo">Sitio Web</h3>
              <p className="datos-valor">
                <a
                  href={
