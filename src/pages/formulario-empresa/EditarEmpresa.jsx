...
import { addCompany, findCompany, updateCompany } from "../../utils/apiDb/apiDbAcions";
...
const EditarEmpresa = () => {
    ...
    const find = async () => {
        ...
        setImages(
            auxFormData.images.images.map((imageData, index) =>
                <div /*onClick={() => clearFileInInput(ima.name)} */className="carga-image-cont">
                    <img src="/images/icons/delete.png" alt="Eliminar Imagen" className="carga-image-deleteIcon" />
                    <img
                        key={index}
                        src={imageData.url}
