...
const Perfil = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append(
      "file",
      document.querySelector(".perfil_file_input").files[0]
    );
  ...
  return (
    <section className="background">
      <form
        className="form-prueba border border-gray-300 rounded-md p-6 userUpdateForm"
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-4">
                ...
                >
                  <p className="obligatorio">*</p>Nombre de usuario
                </label>
                <div className="mt-2">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-3">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  <p className="obligatorio">*</p>Nombre
                </label>
                <div className="mt-2">
                  <input
                    onChange={handleChange}
              ...
              <div className="sm:col-span-3">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  <p className="obligatorio">*</p>Apellido
                </label>
                <div className="mt-2">
                  <input
                    onChange={handleChange}
              ...
              <div className="sm:col-span-4">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  <p className="obligatorio">*</p>Mail
                </label>
                <div className="mt-2">
                  <input
                    onChange={handleChange}
              ...
              <div className="sm:col-span-3">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  <p className="obligatorio">*</p>País
                </label>
                <div className="mt-2">
                  <select
                    onChange={handleChange}
              ...
              <span className="select-none  text-gray-500 w-full ">
                *Campos obligatorios
              </span>
            </div>
          </div>
