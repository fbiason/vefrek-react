...
const Perfil = () => {
    ...
    const find = async () => {
        ...
        if (response.success) {
            if (!response.userData.username) response.userData.username = userData.email;
    ...
    const handleSubmit = async (e) => {
        ...
        if (!verifyIfHasChanges(initialData.current, formDataRef.current) && avatarFileInput.files.length === 0) {
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    {(formData.avatar.url && (
                                        <img className="perfil_avatar" src={formData.avatar.url} alt="avatar" />
                                    )) ||
                                        (!formData.avatar.url && (
                                            <UserCircleIcon
