...
const PaginaEmpresa = () => {
  ...
  const find = async () => {
    ...
    const response = await findCompany(
      "vefrek_website",
      vefrek_website,
      "-reviews.userEmail -reviews.comment -reviews.date -reviews._id"
    );
    if (response.success) {
                  ...
                  <div className="reseña-container">
                    ...
                    <div className="row container mt-5">
                      ...
                      <p>
                        ...
                        Architecto possimus aut aliquam officiis maxime ratione!
                        Libero error dolores id minima enim, mollitia in veniam
                        beatae facilis autem nisi, eius deserunt!
                      </p>
                    </div>
                    <div className="row container mt-5">
                      <div className="col-6">
